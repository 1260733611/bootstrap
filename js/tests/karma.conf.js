...
module.exports = (config) => {
  ...
  config.set({
    ...
    files: [
      ...
      'js/dist/coverage/util.js',
      'js/dist/coverage/tooltip.js',
      'js/dist/coverage/!(util|index|tooltip).js', // include all of our js/dist files except util.js, index.js and tooltip.js
      'js/tests/unit/*.js'
    ],
